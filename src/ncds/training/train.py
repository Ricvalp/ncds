...
from ncds.models.utils import plot_vector_field, plot_solution_trajectories
...
def integrate_ncds(initial_points: jnp.ndarray, ncds: NCDS, dt: float, num_steps: int) -> jnp.ndarray:
